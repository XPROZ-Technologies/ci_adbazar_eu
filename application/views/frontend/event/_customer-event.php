...
<head>
  ...
  <link rel="stylesheet" href="css/edit.css?version=5">
    ...
    <nav class="navbar navbar-expand-xl">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="./images/footer-logo.svg" alt="logo image" class="img-fluid">
        </a>
            ...
            <div class="col-xl-8">
              <div class="customer-event-content">
                <div class="text-white text-center customer-event-top">
                    <h4 class="card-title mb-0 page-title-md fw-bold"><span>06</span>Upcoming Events</h4>
                </div>
                <div class="wrapper-search">
                  <form class="d-flex search-box">
                      <a href="#" class="search-box-icon"><img src="./images/ic-search.svg" alt="search icon"></a>
                  ...
                  <div class="wrapper-list">
                    <div class="w-100 d-flex flex-column flex-lg-row customer-event-item">
                        <a href="#" class="event-img">
                            <img src="https://loremflickr.com/200/200" alt="event image">
                        </a>
                        <div class="event-text">
                            <a href="#" class="event-header page-text-lg fw-500">50% OFF  for all new customers</a>
                            ...
                            <a href="" class="event-join btn btn-outline-red mt-2 mt-lg-0">Join</a>
                        </div>
                    </div>
                    <div class="w-100 d-flex flex-column flex-lg-row customer-event-item">
                        <a href="#" class="event-img">
                    ...
                    <div class="col-lg-6 page-footer-left">
                        <div class="page-footer-info">
                            ...
                            <ul class="list-unstyled page-text-md">
                                <li><img src="./images/ic-telephone.svg" alt="icon ic-telephone">+420 938 934 389</li>
                                <li><img src="./images/ic-email.svg" alt="icon mail">asiadragonbazar@adbazar.eu</li>
                                <li><img src="./images/ic-place.svg" alt="icon place">Svatý Kříž 281, 35002 Cheb,
                                    Czech Republic</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="page-footer-right">
                            ...
                            <ul class="list-unstyled list-inline list-social">
                                <li class="list-inline-item"><a href="#" ><img src="./images/ic-fb-footer.svg" alt="icon fb"></a></li>
                                <li class="list-inline-item"><a href="#"><img src="./images/ic-instagram-footer.svg" alt="ic-instagram"></a></li>
                                <li class="list-inline-item"><a href="#"><img src="./images/ic-music-footer.svg" alt="icon music"></a></li>
                                <li class="list-inline-item"><a href="#"><img src="./images/ic-twitter-footer.svg" alt="icon twitter"></a></li>
                                <li class="list-inline-item"><a href="#"><img src="./images/ic-pinterest.svg" alt="icon pinterest"></a></li>
                            </ul>
