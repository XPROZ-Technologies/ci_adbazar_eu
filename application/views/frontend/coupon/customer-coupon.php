          ...
          <div class="d-flex align-items-center notification-sort">
            ...
            <div class="custom-select mb-0 choose-order">
              <select>
                ...
                <option value="asc" <?php if(isset($order_by) && $order_by == 'asc'){ echo 'selected="selected"'; } ?>><?php echo $this->lang->line('1310_oldest'); ?></option>
              </select>
            </div>
          </div>
        </div>
                      ...
                      <div class="customer-coupon-body">
                        ...
                        <p class="card-text page-text-xs">
                          <?php if($language_id == 1){ ?>
                            <?php echo ddMMyyyy($itemCoupon['start_date'], 'M d, Y'); ?> - <?php echo ddMMyyyy($itemCoupon['end_date'], 'M d, Y'); ?>
                            <?php } else { ?> 
                              <?php echo ddMMyyyy($itemCoupon['start_date'], 'd/m/Y'); ?> - <?php echo ddMMyyyy($itemCoupon['end_date'], 'd/m/Y'); ?>
                          <?php } ?>
                        </p>
