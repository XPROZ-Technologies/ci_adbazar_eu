<div class="bm-left show-mobile-ic">
    ...
    <aside class="bp-sidebar">
        <ul class="list-unstyled">
            ...
            <li class="<?php if(isset($activeBusinessMenu) && $activeBusinessMenu == 'reviews'){ echo 'active'; } ?>"><a href="<?php echo base_url('business-management/' . $businessInfo['business_url'] . '/reviews') ?>" class="btn-join-as-guest"><?php echo $this->lang->line('reviews'); ?></a></li>
            <li class="<?php if(isset($activeBusinessMenu) && $activeBusinessMenu == 'reservations'){ echo 'active'; } ?>"><a href="<?php echo base_url('business-management/' . $businessInfo['business_url'] . '/reservations') ?>" class="btn-join-as-guest"><?php echo $this->lang->line('reservations'); ?></a></li>
