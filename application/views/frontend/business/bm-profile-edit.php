        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            <div class="bm-create-content">
              ...
              <!-- END. avatar -->
              <form action="<?php echo base_url('business-profile/udpate-business'); ?>" class="row create-form" method="POST" id="formCreateBusiness" enctype="multipart/form-data">
                ...
                <div class="col-12">
                  <div class="form-group mb-3">
                    ...
                    <div class="position-relative text-url">
                      ...
                      <input type="url" class="form-control form-control-lg" placeholder="" aria-label="Custom URL" name="business_url" id="business_url" value="<?php echo $businessInfo['business_url']; ?>">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group mb-3">
                    ...
                    <input type="tel" class="form-control form-control-lg" id="bm-whatapp" aria-label="WhatsApp number" name="business_whatsapp" value="" value="<?php echo $businessInfo['business_whatsapp']; ?>">
                  </div>
                </div>
                        ...
                        <?php foreach ($businessOpeningHours as $indexHours => $itemOpenHous) { ?>
                          <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between open-hour-item">
                            ...
                            <div class="d-flex flex-column flex-md-row align-items-md-center body-content">
                              <div class="d-flex align-items-center switch-btn  <?php if($itemOpenHous['opening_hours_status_id'] == 1){ echo "disabled"; } ?> ">
                                <input id="checkbox<?php echo $itemOpenHous['day_id']; ?>" type="checkbox" class="checkbox" name="open_hours[<?php echo $itemOpenHous['day_id']; ?>][opening_hours_status_id]" <?php if($itemOpenHous['opening_hours_status_id'] == 2){ echo "checked"; } ?> />
                                ...
                                <p class="mb-0 switch-text"><?php if($itemOpenHous['opening_hours_status_id'] == 2){ echo "Open"; }else{ echo "Closed"; } ?></p>
                              </div>
                              <div class="d-flex align-items-center wrapper-time">
                                <div class="position-relative time-content">
                                  <input value="<?php echo ddMMyyyy($itemOpenHous['start_time'], 'H:i'); ?>" type="text" class="form-control form-control-lg datetimepicker-input js-time-picker" <?php if($itemOpenHous['opening_hours_status_id'] == 1){ echo "disabled"; } ?> name="open_hours[<?php echo $itemOpenHous['day_id']; ?>][start_time]" id="timePicker1" data-toggle="datetimepicker" data-target="#timePicker1" placeholder="Open at"  />
                                </div>
                                <span class="text-to">to</span>
                                <div class="position-relative time-content">
                                  <input value="<?php echo ddMMyyyy($itemOpenHous['end_time'], 'H:i'); ?>" type="text" class="form-control form-control-lg datetimepicker-input js-time-picker" <?php if($itemOpenHous['opening_hours_status_id'] == 1){ echo "disabled"; } ?> name="open_hours[<?php echo $itemOpenHous['day_id']; ?>][start_time]" id="timePicker2" data-toggle="datetimepicker" data-target="#timePicker2" placeholder="Open at" />
                                </div>
                              </div>
                            </div>
                          </div>
