          ...
          <div class="col-lg-10">
            <div class="bm-create-content">
              ...
              <form action="<?php echo base_url('business-profile/update-business'); ?>" class="row create-form" method="POST" id="formCreateBusiness" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                  <div class="form-group mb-3">
                    ...
                    <div class="dropdown dropdown-country page-text-lg">
                      <input type="hidden" class="form-control" id="businessPhoneCode" name="country_code_id" value="<?php echo $businessInfo['country_code_id']; ?>">
                ...
                <!--phone  code for whatsapp -->
                <div class="col-md-4">
                  <div class="form-group mb-3">
                    <label class="form-label"><?php echo $this->lang->line('input_country_code'); ?><span class="text-danger required">*</span></label>
                    <div class="dropdown dropdown-country page-text-lg">
                      <input type="hidden" class="form-control" id="businessPhoneCodeWhatsapp" name="country_code_whatsapp_id" value="<?php echo $businessInfo['country_code_whatsapp_id']; ?>">
