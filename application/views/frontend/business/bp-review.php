      ...
      <div class="container">
        ...
        <div class="header-right-mobile">
          ...
          <div class="d-flex align-items-center d-xl-none">
            ...
            <div class="d-flex btn-user">
              <a href="signup.html" title="" class="btn btn-outline-red btn-register">Sign up</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-flex align-items-center navbar-right">
            ...
            <div class="dropdown dropdown-language ml-32">
              <a href="#" class="wrapper-btn dropdown-toggle current" id="languageDropdown" data-bs-toggle="dropdown" aria-expanded="false" value="en">
                <img src="./images/en.png" alt="english flag" class="img-fluid">
              </a>
              <ul class="dropdown-menu js-list-language" aria-labelledby="languageDropdown">
  ...
  <main>
    <div class="page-business-profile">
      ...
      <div class="bp-top-img">
          <div class="bp-header">
              <img src="./images/img-business-profile.jpeg" alt="business profile image" class="img-fluid">
              <h3 class="text-center page-title fw-bold text-black">Inspire Beauty Salon</h3>
              <p class="mb-0 page-text-lg text-black text-center">Slogan here or Short description sentences (Hair - Nails - Wimpers)</p>
          </div>
      </div>
              ...
              <div class="bp-tabs-left">
                 <aside class="bp-sidebar">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="bp-coupon.html">Coupons</a></li>
                        <li><a href="bp-event.html">Events</a></li>
                        <li><a href="bp-review.html">Reviews</a></li>
                        <li><a href="bp-reservation.html">Reservation</a></li>
                    </ul>
                </aside>
              </div>
            </div>
                  ...
                  <div class="col-review">
                    <div class="d-flex justify-content-lg-end">
                      <a href="#" class="review-btn btn btn-red">
                        <img src="./images/icon-up.png" alt="icon-edit" class="img-fluid me-2">
                        Leave a review</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="bp-inner-content">
                    <div class="notification-wrapper-filter d-flex align-items-center justify-content-md-between">
                      ...
                      <div class="d-flex align-items-center notification-sort">
                          <img src="./images/ic-sort.png" alt="sort icon" class="img-fluid me-2">
                  ...
                  <div class="list-comment">
                    <div class="d-flex flex-column flex-lg-row comment-item">
                      <div class="comment-img">
                        <img src="./images/review-avatar.jpg" alt="comment avatar" class="img-fluid">
                      ...
                      <div class="comment-body">
                        ...
                        <div class="text-right">
                          ...
                          <a href="" title="" class="btn btn-outline-red d-inline-block"><img src="./images/icon-del.png" alt=""> Delete</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="list-comment">
                    ...
                    <div class="d-flex flex-column flex-lg-row comment-item">
                      ...
                      <div class="comment-body">
                        ...
                        <img src="./images/review-img-comment.svg" alt="comment avatar" class="img-fluid">
                        <p class="page-text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in maximus libero. Fusce
                          vulputate, lectus vitae rhoncus bibendum, eros purus dignissim sapien, sit amet sollicitudin
                          nulla felis sit amet sem. Proin augue felis, luctus vitae enim eu, consectetur rhoncus ligula.
                          Donec elementum fringilla rhoncus. Vestibulum in accumsan velit. Donec interdum.
