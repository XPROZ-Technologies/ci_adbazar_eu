                ...
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-lg-8 d-flex flex-column justify-content-center align-items-center">
                            ...
                            <a href="<?php echo base_url('business-profile/create-new-business?plan='.$plan); ?>" class="btn btn-red btn-create-bp">+ <?php echo $this->lang->line('create_a_business_profile'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
