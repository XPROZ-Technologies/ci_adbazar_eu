...
<div class="modal fade bm-coupon-modal bm-found" id="bmCouponAlertModalAvail" tabindex="-1" aria-labelledby="bmCouponAlertModalAvailLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <p class="page-text-lg mb-0">
          We found your code: <b class="couponCodeEntered">AH1234</b>
        </p>
        <p class="page-text-lg mb-0">
        ...
        <div class="modal-footer border-top-0 justify-content-center p-0">
          <button type="button" class="btn btn-red btn-ok btn-active-coupon">Yes</button>
          <button type="button" class="btn btn-outline-red btn-ok" data-bs-dismiss="modal">No</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade bm-coupon-modal" id="bmCouponAlertModalUsed" tabindex="-1" aria-labelledby="bmCouponAlertModalUsedLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body text-center">
        <p class="page-text-lg mb-0">
          Your code <b class="couponCodeEntered">AH1234</b> has been used or is expired.
        </p>
        <p class="page-text-lg mb-0">
