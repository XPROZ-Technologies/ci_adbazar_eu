<?php $this->load->view('frontend/includes/header'); ?>
                            ...
                            <div class="bm-gallery">
                                <div class="d-flex justify-content-end add-gallery">
                                    <button class="btn btn-red" data-bs-toggle="modal"
                                        data-bs-target="#addGalleryModal"><img src="assets/img/frontend/ic-upload.png"
                                            alt="ic-upload"> Add
                                ...
                                <div class="bp-gallery">
                                    <ul class="nav nav-pills justify-content-center page-text-lg" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="pills-photo-tab" data-bs-toggle="pill" data-bs-target="#pills-photo"
                                                type="button" role="tab" aria-controls="pills-photo" aria-selected="true">Photos</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-video-tab" data-bs-toggle="pill" data-bs-target="#pills-video"
                                                type="button" role="tab" aria-controls="pills-video" aria-selected="false">Videos</button>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-6 col-lg-3">
                                                            <div class="photo-item">
                                                                ...
                                                                <a href="#" class="photo-icon js-dropdown-gallery">
                                                                    <img src="assets/img/frontend/ic-edit-gallery.png" alt="ic-edit-gallery">
                                                                </a>
                                                                <!-- <ul class="dropdown-menu dropdown-gallery">
                                                                    <li><a class="dropdown-item" href="#"><img src="assets/img/frontend/ic-gallery-user.svg" alt="ic-gallery-user">Use as profile
                                                                            photo</a></li>
                                                                    <li><a class="dropdown-item" href="#"><img src="assets/img/frontend/ic-gallery-cover.svg" alt="ic-gallery-user">Use as cover
                                                                            photo</a></li>
                                                                    <li><a class="dropdown-item" href="#"><img src="assets/img/frontend/ic-gallery-download.svg"
                                                                                alt="ic-gallery-user">Download</a></li>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video1.png" class="js-video">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video3.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video4.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video5.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video6.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video7.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video8.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video9.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="video-item">
                                                                ...
                                                                <video poster="assets/img/frontend/poster-video10.png" class="js-video">
                                                                    <source src="assets/img/frontend/demo.mp4" type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                <a href="#deleteVideoModal" data-bs-toggle="modal" class="icon-delete">
    ...
    <div class="uploading">
        ...
        <div class="uploading-body">
            ...
            <div class="modal fade bmGalleryModal" id="addGalleryModal" tabindex="-1"
                            ...
                            <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true">Upload Photos</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-profile" type="button" role="tab"
                                        aria-controls="pills-profile" aria-selected="false">Upload Videos</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="text-right"> 
                                                <div class="position-relative" >
                                                    <div class="drop-zone__prompt">
                                                        <img src="assets/img/frontend/ic-cloud.png" alt="ic-cloud image"
                                                            class="img-fluid">
            ...
            <!-- Modal Delete Video -->
            <div class="modal fade bmDeleteModal" id="deleteVideoModal" tabindex="-1"
            ...
            <!-- Modal Delete Photo -->
            <div class="modal fade bmDeleteModal" id="deletePhotoModal" tabindex="-1"
