  ...
  <header class="page-header">
    ...
    <main>
        <div class="page-business-profile">
            <div class="d-flex flex-column align-items-center flex-md-row justify-content-center um-top">
                    ...
                    <div class="bm-innner-list grid-40">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                <div class="card bm-item">
                                    <a href="#" class="d-block bm-item-img">
                                        <img src="./images/bm-image1.png" class="card-img-top img-fluid"
                                            alt="business manager image">
                                    </a>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card bm-item">
                                    <a href="#" class="d-block bm-item-img">
                                        <img src="./images/bm-image2.png" class="card-img-top img-fluid"
                                            alt="business manager image">
                                    </a>
                                    <div class="card-body pt-0">
                                        <h5 class="card-title page-text-lg text-black text-center">Fusion Restaurant
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card bm-item">
                                    <a href="#" class="d-block bm-item-img">
                                        <img src="./images/bm-image3.png" class="card-img-top img-fluid"
                                            alt="business manager image">
                                    </a>
                                    <div class="card-body pt-0">
                                        <h5 class="card-title page-text-lg text-black text-center">Fusion Restaurant
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card bm-item">
                                    <a href="#" class="d-block bm-item-img">
                                        <img src="./images/bm-image4.png" class="card-img-top img-fluid"
                                            alt="business manager image">
                                    </a>
                                    <div class="card-body pt-0">
                                        <h5 class="card-title page-text-lg text-black text-center">Fusion Restaurant
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card bm-item">
                                    <a href="#" class="d-block bm-item-img">
                                        <img src="./images/bm-image5.png" class="card-img-top img-fluid"
                                            alt="business manager image">
                                    </a>
                                    <div class="card-body pt-0">
                                        <h5 class="card-title page-text-lg text-black text-center">Fusion Restaurant
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="card bm-item bm-item-add">
                                    <img src="./images/bm-plus.png" alt="plus icon">
                                </div>
                            </div>
                        </div>
