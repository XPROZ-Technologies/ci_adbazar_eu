                ...
                <div class="bp-event-content">
                  <div class="wrapper-search">
                    <form class="d-flex search-box" action="<?php echo $basePagingUrl; ?>" method="GET" name="searchForm">
                      ...
                      <input class="form-control" type="text" placeholder="Search" aria-label="Search" name="keyword" aria-label="Search" value="<?php echo $keyword; ?>">
                    </form>
                  </div>
                      ...
                      <?php foreach ($lists as $key => $eventItem) {
                        ...
                        <div class="w-100 d-flex flex-column flex-lg-row customer-event-item event-item-<?php echo $eventItem['id']; ?>">
                          ...
                          <div class="event-text">
                            ...
                            <a href="javascript:void(0)" class="event-join btn btn-outline-red mt-2 mt-lg-0 join-event-in-list" data-id="<?php echo $eventItem['id']; ?>" data-customer="<?php echo $customer['id']; ?>" >Join</a>
                          </div>
                        </div>
                      <?php } ?>
                      <!-- END. item event -->
