    ...
    <div class="bm-event-create">
      <div class="create-top">
        <div class="container text-center">
          <h3 class="fw-bold page-title-md mb-4">Edit event</h3>
        </div>
      </div>
      ...
      <div class="create-event">
        <div class="container">
          <div class="w-550">
            <form action="<?php echo base_url('business-management/edit-event'); ?>" class="row" id="formCreateEvent" method="POST">
