                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="event_subject" id="event_subject" class="form-control hmdrequired" data-field="Subject" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="end_date" id="end_date" class="form-control hmdrequired" data-field="End Date" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="9"  class="form-control" name="event_description"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box box-default">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo EVENTS_PATH.NO_IMAGE; ?>" id="imgImage" style="width: 280px;">
                                    <input type="text" hidden="hidden" id="logoImageImage" name="event_image">
