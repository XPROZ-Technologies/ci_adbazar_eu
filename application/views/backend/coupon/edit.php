                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="business_profile_id" id="business_profile_id">
                                            <option value="<?php echo $businessprofile['id'] ?>"><?php echo $businessprofile['business_name']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" autocomplete="off" disabled value="<?php echo $coupon['coupon_code']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="coupon_subject" id="coupon_subject" class="form-control hmdrequired" data-field="Subject" autocomplete="off" value="<?php echo $coupon['coupon_subject']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="start_date" id="start_date" class="form-control hmdrequired" data-field="Start Date" autocomplete="off" value="<?php echo ddMMyyyy($coupon['start_date']); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="end_date" id="end_date" class="form-control hmdrequired" data-field="End Date" autocomplete="off" value="<?php echo ddMMyyyy($coupon['end_date']); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="9"  class="form-control" name="coupon_description"><?php echo $coupon['coupon_description']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box box-default">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo COUPONS_PATH.$coupon['coupon_image']; ?>" id="imgImage" style="width: 280px;">
